...
export default function Signup() {
    ...
    console.log(generateAvatar('testuser'))
    ...
    const handleSignup = async () => {
        ...
        try {
            ...
            const avatarUrl = await generateAvatar(formData.username); // Generate avatar URL
...
<div className="auth-form">
                <form onSubmit={handleSubmit}>
                    ...
                    <button className="auth-button" type="submit">{isLogin ? "Log In" : "Sign Up"}</button>        
                </form>
